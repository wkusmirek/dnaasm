...
namespace dnaasm { namespace bst {
    Consensus::Consensus(unsigned pathWidth)
        :bestSizeX_(0), bestSizeY_(0), pathWidth_(pathWidth)
    {
        iter_ = consensus_.begin();
    }

    void Consensus::setAssociations(std::unique_ptr<std::vector<unsigned>> associations)
    {
    ...
    std::unique_ptr<std::string> Consensus::toString()
    {
    ...
    void Consensus::run(std::vector<std::string>& reads)
    {
        add(reads[0]);
        //if(!associations_)
        //{
        ...
        //{
            ...
            //     if(i%100==0)
            //         std::cout << i << std::endl;
            //     unsigned size = std::max(reads[i].size() * 1.1, const _Tp &__b)
            //     compare(reads[i]);
            //     //std::cout << i << std::endl;
            // }
        //}
    ...
    void Consensus::compare(std::string& str)
    {
        ...
        // TODO: think about it
        // find length of consensus to compare
