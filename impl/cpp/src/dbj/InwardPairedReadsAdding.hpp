/**
 * \file InwardPairedReadsAdding.hpp
 * \brief the C++ file with implementation of template class for adding inward (-> <-) paired reads to graph
 *
 */

#ifndef INWARD_PAIRED_READS_ADDING_HPP
#define INWARD_PAIRED_READS_ADDING_HPP
...
namespace dnaasm { namespace dbj {
    /**
     * \brief Class to add inward paired reads to sequences graph
    */
    template<class SequencesGraph> class InwardPairedReadsAdding {
    public:

        /**
         * \brief InwardPairedReadsAdding constructor.
         *
         ...
         * \return returns void
         */
        InwardPairedReadsAdding(FileReader& fileReader,
        ...
        void operator()() {
            ...
            unsigned int k = 0U;
            fileReader_.reset();
            logInfo("mapping inward paired reads...");
            ...
            while (true) {
                ...
                pairedRead.makeComplementaryStrand();    //changing FR reads to FF
                ...
                if (!fileReader_.getIsMoreSequences()) {
                    logInfo("adding inward paired reads done");
                    return;
                }
            }
        }
    ...
    private:
        ...
        InwardPairedReadsAdding& operator=(const InwardPairedReadsAdding&)= delete;
    };

}}

#endif    // INWARD_PAIRED_READS_ADDING_HPP
