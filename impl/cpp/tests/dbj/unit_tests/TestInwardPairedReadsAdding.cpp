/**
 * \file TestInwardPairedReadsAdding.cpp
 * \brief the C++ file with implementation of tests for InwardPairedReadsAdding class
 *
 */

#include <boost/test/unit_test.hpp>

#include "../../../src/dbj/InwardPairedReadsAdding.hpp"
...
BOOST_AUTO_TEST_SUITE(TestInwardPairedReadsAdding)
...
BOOST_AUTO_TEST_CASE(basic_single_test)
{
    ...
    InwardPairedReadsAdding< UnitigsToContigsExtension > addInwardPairedReads(fileReader, unitigsToContigsExtension, 10, NULL);
    ...
    InwardPairedReadsAdding< UnitigsToContigsExtension > addInwardPairedReads2(fileReader2, unitigsToContigsExtension, 10, NULL);
    addInwardPairedReads2();
    BOOST_CHECK_EQUAL(num_vertices(unitigsToContigsExtension.getUnitigsGraph()), 2);
    BOOST_CHECK_EQUAL(num_edges(unitigsToContigsExtension.getUnitigsGraph()), 1);
    BOOST_CHECK_EQUAL(unitigsToContigsExtension.getUnitigsGraph()[0].isLongNode_, false);
    BOOST_CHECK_EQUAL(unitigsToContigsExtension.getUnitigsGraph()[1].isLongNode_, false);
